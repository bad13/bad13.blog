...
on the linux server
set ssh user
> add user your-username #-> set a password and skip all with enter 
...
on your local machine in my case windows
in powershell create a key-pair 
> ssh-keygen -b 4096 #-> skip all with enter
copy your public key to your remote server (*.pub)
